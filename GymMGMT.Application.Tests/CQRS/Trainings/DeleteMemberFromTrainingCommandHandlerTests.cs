...
namespace GymMGMT.Application.Tests.CQRS.Trainings
{
    public class DeleteMemberFromTrainingCommandHandlerTests
    {
        ...
        public async Task Handle_ForValidCommand_ReturnSuccessResponse()
        {
            ...
            var handler = new DeleteMemberFromTrainingCommandHandler(_trainingRepositoryMock.Object,
                _memberRepositoryMock.Object, _currentUserService);
            var command = new DeleteMemberFromTrainingCommand()
            {
